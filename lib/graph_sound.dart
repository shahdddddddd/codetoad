...
class SoundGraph extends StatefulWidget {
  const SoundGraph({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  // ignore: library_private_types_in_public_api
  SoundScreen createState() => SoundScreen();
}

class SoundScreen extends State<SoundGraph> {
  ...
  void updateDataSource(Timer timer) {
    chartData.add(LiveData(time++, getRandom()+65));
  ...
  double getRandom() {
    ...
    double randomNumber = Random().nextInt(10) + randomDec;
    return randomNumber;
  }
